...
is_target()
{
  ...
  IfWinActive,ahk_class cygwin/x X rl-xterm-XTerm-0
    Return 1
  IfWinActive,ahk_class MozillaWindowClass ; keysnail on Firefox
    Return 1
...
kill_line()
{
  ...
  Sleep 1 ;[ms] this value depends on your environment
  ;Send ^x
  Send {Del}
  global is_pre_spc = 0
  Return
...
^e::
  ...
  Return
^p::
  If is_target() or (IME_GETConverting() == 2)
    Send %A_ThisHotkey%
  Else
    previous_line()
  Return
